...
/// <param name="PatchIndex">The complete relative header, hunk, and line index for the file patch.</param>
...
{
    /// <summary>
    /// Gets whether the file patch contains at least one validated textual hunk.
    /// </summary>
    internal bool HasHunks => !PatchIndex.Hunks.IsEmpty;
}
