...
GitSail is a keyboard-first Git client for the terminal. It is an independently
implemented, MIT-licensed application that delegates repository semantics to an
